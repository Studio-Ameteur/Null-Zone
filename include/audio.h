...
inline bool audio_init() {
    ...
    Mix_Chunk* gunshot = Mix_LoadWAV("assets/music/16551_1460656891.mp3");
    Mix_Chunk* footstep = Mix_LoadWAV("assets/music/steps-2.mp3");

    g_sounds[SND_PISTOL]        = gunshot;
    g_sounds[SND_SHOTGUN]       = gunshot;
    g_sounds[SND_AUTO]          = gunshot;
    g_sounds[SND_SNIPER]        = gunshot;
    g_sounds[SND_ROCKET]        = gunshot;
    g_sounds[SND_PLASMA]        = gunshot;
    g_sounds[SND_SUPER_SHOTGUN] = gunshot;
    g_sounds[SND_FLAMETHROWER]  = gunshot;
    g_sounds[SND_RAILGUN]       = gunshot;
    g_sounds[SND_GRENADE]       = gunshot;
    g_sounds[SND_MINIGUN]       = gunshot;
    g_sounds[SND_CRYO]          = gunshot;
    g_sounds[SND_CHAINSAW]      = gen_chainsaw();
    g_sounds[SND_BFG]           = gunshot;
    g_sounds[SND_FISTS]         = gen_fists();
    g_sounds[SND_STEP_METAL]    = footstep;
    g_sounds[SND_STEP_CONCRETE] = footstep;
