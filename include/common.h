...
static const double ROT_SPEED        = 0.0018;
static const double ROT_SPEED_LOW    = 0.0010;
static const double ROT_SPEED_MED    = 0.0018;
static const double ROT_SPEED_HIGH   = 0.0030;
static const double ROT_SPEED_VHIGH  = 0.0045;
...
static double g_mouse_sensitivity = ROT_SPEED_MED;

inline void sensitivity_set(int level) {
    switch(level) {
    case 0: g_mouse_sensitivity = ROT_SPEED_LOW;   break;
    case 1: g_mouse_sensitivity = ROT_SPEED_MED;   break;
    case 2: g_mouse_sensitivity = ROT_SPEED_HIGH;  break;
    case 3: g_mouse_sensitivity = ROT_SPEED_VHIGH; break;
    default:g_mouse_sensitivity = ROT_SPEED_MED;   break;
    }
}
